...
TEST_F(Exam014_250126_Tests, DefaultTestCase01) {
    const string result = solution(
        vector<string>{"pencil", "pencil", "pencil", "book"},
        vector{2, 4, 3, 1}
    );
...
TEST_F(Exam014_250126_Tests, DefaultTestCase02) {
    const string result = solution(
        vector<string>{"doll", "doll", "doll", "doll"},
        vector{1, 1, 1, 1}
    );
...
TEST_F(Exam014_250126_Tests, DefaultTestCase03) {
    const string result = solution(
        vector<string>{"apple", "steel", "leaf", "apple", "leaf"},
        vector{5, 3, 5, 3, 7}
    );
...
TEST_F(Exam014_250126_Tests, DefaultTestCase04) {
    const string result = solution(
        vector<string>{"mirror", "net", "mirror", "net", "bottle"},
        vector{4, 1, 4, 1, 5}
    );
